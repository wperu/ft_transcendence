...
export class AuthController
{
    ...
    @Get('/login')
    @Redirect('https://api.intra.42.fr/oauth/authorize?client_id=bf3306f6006c4a21b8c541ff8caf0218d9a896bba88a45bc6a1506b1b0b08301&redirect_uri=http%3A%2F%2Flocalhost%2Fapi%2Fauth%2Fintra42%2Fcallback&response_type=code', 301)
    async   login()
    {
